...
class MemberCommunicationController extends Controller
{
    public function index()
    {
    	...
    	return view('web.communication.list',compact('communication','ventures'));
    }
    ...
    public function show($id)
    {
		...
		$communication->save();
    	return view('web.communication.show',compact('communication'));
    }
    ...
    public function storeCommunicationVPM(Request $request)
    {
    	$venture_id = $request->venture_id;
    	$subject 	= $request->subject;
    	$body 		= $request->body;
    	...
    	$user 		= Auth::user();
        $user_ids   = VentureManager::where('venture_id',$venture_id)->pluck('user_id');
    ...
    public function communicationSearch(Request $request)
    {
        try{
            ...
            $view = (string)view('web.communication.search_table_row',compact('communication'));
            return response()->json([
                'view' => $view,
                'status' => true,
