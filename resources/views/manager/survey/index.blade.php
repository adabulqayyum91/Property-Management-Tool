                                    ...
                                    <div class="dashboard-list">
                                        <div class="dashboard-message bdr clearfix ">
                                            <div class="tab-box-2">
                                                ...
                                                <a href="{{url('/manager/survey/create')}}" style="margin-top:-10px" class="btn btn-warning float-right">Create Survey</a>
                                                <div class="clearfix mb-30 comments-tr">
                                                    <span>Sruveys</span>
                                                </div>
                                                <div id="survey-id">
                                                    @include('manager.survey.search_table_row')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#delete-emails').click(function () {     
                ...
                var checkedArray = [];
                var input = document. getElementsByName('surveys_id[]'); 
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('/manager/survey/bulk-delete') }}",
