  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  	<ul>
  	    ...
  	    <li  class="{{ (request()->is('admin/plans') ? 'active' : '' || request()->is('admin/plans/create')) ? 'active' : '' }}">
  	        <a style="color: #c5c5c5;" data-toggle="collapse" data-target="#demoCms">
  	            <i class="fa fa-home"></i> CMS
  	        </a>
  	        <div id="demoCms" style="background-color: #5a5858;color: black;" class="collapse">
  	    ...
  	    <li >
  	        <a style="color: #c5c5c5;" data-toggle="collapse" data-target="#demoUsers">
  	            <i class="fa fa-home"></i> Users


  	        </a>
  	        <div id="demoUsers" style="background-color: #5a5858;color: black;" class="collapse">
  	   ...
  	   <a href="{{url('admin/billing-info')}}"><i class="fa fa-users" aria-hidden="true"></i> Billing Detail</a>
  	    ...
  	    <li class="{{ (request()->is('admin/ventures') ? 'active' : '' || request()->is('admin/ventures/create')) ? 'active' : '' }}">
  	        <a style="color: #c5c5c5;" data-toggle="collapse" data-target="#ventures">
  	            <i class="fa fa-money" aria-hidden="true"></i> Ventures
  	        </a>
  	        <div id="ventures" style="background-color: #5a5858;color: black;" class="collapse">
  	            ...
  	            <a href="{{url('admin/new-venture-listing')}}"><i class="fa fa-users" aria-hidden="true"></i>  New Venture Listing</a>
  	              <a href="{{url('admin/current-venture-listing')}}"><i class="fa fa-users" aria-hidden="true"></i>  Current Venture Listing</a>
  	              <a href="{{url('admin/venture-listing/buy-now')}}"><i class="fa fa-users" aria-hidden="true"></i>  Venture Buy Now</a>
  	              <a href="{{url('admin/venture-listing/offer')}}"><i class="fa fa-users" aria-hidden="true"></i>  Venture Offer</a>
  	    ...
  	    <li class="{{ (request()->is('admin/imports') ? 'active' : '' || request()->is('admin/imports')) ? 'active' : '' }}">
  	        <a style="color: #c5c5c5;" data-toggle="collapse" data-target="#imports">
  	            <i class="fa fa-money" aria-hidden="true"></i> Imports
  	        </a>
  	        <div id="imports" style="background-color: #5a5858;color: black;" class="collapse">
  	    ...
  	    <li class="active">
  	        <a style="color: #c5c5c5;" data-toggle="collapse" data-target="#settings">
  	            <i class="fa fa-money" aria-hidden="true"></i> Setting
  	        </a>
  	        <div id="settings" style="background-color: #5a5858;color: black;" class="collapse">
