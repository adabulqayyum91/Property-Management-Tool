...
@section('page_title')
    Create Referal User | Admin Panel
@endsection
@section('css')
    <style>
                                                    ...
                                                    <form method="POST" name="referralUser">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <button class="btn btn-md btn-theme" type="submit" id="saveReferral" style="border-radius: 50px">Submit</button> </div>
    ...
    <script>
        ...
        function  handleResponse(message) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                location.href = "{{ url('admin/refer-friend')}}";
            } else if (
