                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <ul class="profile-list">
                                                                    ...
                                                                    <li class="clearfix">
                                                                        <strong class="title">Refer By:</strong>
                                                                        <span class="cont">{{!is_null($refferal->user) ? $refferal->user->name : ''}}</span>
                                                                    </li>
                                                                    <li class="clearfix">
                                                                        <strong class="title">Refer By Email:</strong>
                                                                        <span class="cont">{{!is_null($refferal->user) ? $refferal->user->email : ''}}</span>
                                                                    </li>
                                                                    <li class="clearfix">
