                                    ...
                                    <form action="{{route('ventures.store')}}" method="POST">
                                        ...
                                        <div class="dashboard-list">
                                            <div class="dashboard-message bdr clearfix ">
                                                <div class="tab-box-2">
                                                    <div class="clearfix mb-30 comments-tr"> <span>Current Venture Listing </span></div>
                                                    <div class="container">
                                                        <div class="comments-tr2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control box-shadow" placeholder="CAP Rate" name="cap_rate" required>
                                                                        @if($errors->has('managing_member'))
                                                                            <div class = "alert alert-danger">
                                                                                {{ $errors->first('managing_member') }}
                                                                            </div>
                                                    ...
                                                    <div class="container">
                                                        <div class="comments-tr2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <input type="hidden" name="lngLatStatus" value="{{!is_null($newVentureList->longitude)? 'true':'false'}}">
