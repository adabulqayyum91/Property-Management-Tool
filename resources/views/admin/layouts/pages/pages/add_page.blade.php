                                ...
                                <div class="col-lg-12">
                                    <div class="dashboard-list">
                                        <div class="dashboard-message bdr clearfix ">
                                            <div class="tab-box-2">
                                                <div class="clearfix mb-30 comments-tr"> <span>Create Page</span></div>
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label>Content:</label>
                                                                <div class="form-group">
                                                                    <textarea id="editor" name="content" class="col-md-12 box-shadow"></textarea>
