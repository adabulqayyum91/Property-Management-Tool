                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="" placeholder="Venture Name" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="" placeholder="Membership ID" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="" placeholder="Listing ID" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>What % of the Seller’s Ownership Stake are you offering to purchase?</label>
                            <input type="text" name="" placeholder="100%" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <button class="btn btn-success btnloop">Submit
                        </button>
