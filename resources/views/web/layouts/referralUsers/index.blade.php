                                        ...
                                        <div class="dashboard-list">
                                            <div class="dashboard-message bdr clearfix ">
                                                <div class="tab-box-2">
                                                    ...
                                                    <form action="{{route('refer-friends.create')}}" method="GET" class="pull-right">
                                                        <button class="btn btn-linked btn-theme box-shadow " style="border-radius: 50px;margin-bottom: 30px !important;">Refer A Friend</button>
                                                    </form>
                                                    <table id="example" class="table table-bordered box-shadow" style="width:100%">
                                                        ...
                                                        @foreach($referral as $user)
                                                            <tr>
                                                                ...
                                                                <td>{{ !is_null($user->status) ?  $user->status : ''}}</td>
                                                                <td>
                                                                    ...
                                                                    <form action="{{route('refer-friends.show',$user->id)}}" method="GET">
