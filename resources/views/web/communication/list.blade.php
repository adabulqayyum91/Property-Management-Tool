                                        ...
                                        <div class="dashboard-message bdr clearfix ">
                                            <div class="tab-box-2">
                                                ...
                                                <div id="communication-id">
                                                    @include('web.communication.search_table_row')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="compose-email-vo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{url('/user/communication-vo/store')}}">
                    @csrf
    ...
    <script>
        $(document).ready(function(){
            $("#searchSubmit").click(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('/user/communicationSearch') }}",
                    data: formData,
            ...
            $('#delete-emails').click(function () {                
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('/communication/bulk-delete') }}",
